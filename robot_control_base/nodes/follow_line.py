...
from robot_control_base.cfg import FollowLineConfig
...
class FollowLine:
    def __init__(self):
        ...
        #self.twist_pub =
        rospy.Publisher("/vrep/twistCommand",Twist,queue_size=1)
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            theta = euler[2] 
            twist = Twist()
            # TODO: compute twist, knowing current position (x,y,theta) and 
            # goal configuration: self.goal_x, self.goal_y, self.goal_theta
            # Useful functions: sinc, sat, norm_angle (see definition on top of
            # this file)
